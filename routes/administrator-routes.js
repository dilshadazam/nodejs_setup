...
router.post("/add-customer-basic-info", isAdministrator, createCustomer);

router.post("/add-rolemaster", isAdministrator, createRoleMaster);

router.post("/add-loantypes-name", isAdministrator, createLoanTypesName);
...
router.get(
  "/fetch-one-customer-basic-info/:customerUniqueNo",
  isAdministrator,
  getSingleCustData
);
//GET CUSTOMER BASIC INFO SEARCH BY CUSTOMER UNIQUE ID
router.get(
  "/fetch-kyc-completed-customers-list",
  isAdministrator,
  getCustomerKycInfo
);
//GET KYC COMPLETED CUSTOMER INFO SEACRCH BY CUSTOMER UNIQUE ID
router.get(
  "/fetch-one-kyc-customer-basic-info/:customerUniqueNo",
  isAdministrator,
  getSingleCustKycData
);
...
router.delete(
  "/delete-loantype/:loantypesnameId",
  isAdministrator,
  deleteLoantypeNmae
);
